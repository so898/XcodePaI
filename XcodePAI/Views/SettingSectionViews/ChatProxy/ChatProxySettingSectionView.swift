    ...
    var body: some View {
        ScrollView {
            Grid(alignment: .leading, horizontalSpacing: 20, verticalSpacing: 18) {
                ...
                GridRow {
                    Text("Remove Hallucinated Tool Results")
                        .help("Filters out fabricated tool call responses generated by the model. Enable this to improve response accuracy by discarding tool results that the model invented rather than actually executed.")
                    Toggle("Enable", isOn: $removeHallucination)
                        .toggleStyle(.checkbox)
